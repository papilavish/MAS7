    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">My Account</button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="http://localhost:8888/MAS7/MAS7/signin.html">
                                    <button class="dropdown-item" type="button">Sign in</button>
                                  </a>
                                  
                                  <a href="http://localhost:8888/MAS7/MAS7/signup.html">
            ...
            <div class="row align-items-center bg-1c1a32 py-3 px-xl-5 d-none d-lg-flex">
                <a href="MAS7.php" class="text-decoration-none">
                    <div class="col-lg-4">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse bg-ffc107 justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="MAS7.php" class="nav-item nav-link">Home</a>
